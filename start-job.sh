...
accelerate launch --config_file ../swin-transformer-pde/configs/accelerate/single-gpu.yaml scOT/train.py --config configs/run.yaml --wandb_run_name case1 --wandb_project_name scOT-sparse --max_num_train_time_steps 14 --train_time_step_size 1 --data_path /cluster/scratch/herdem/ --checkpoint_path /cluster/work/math/herdem/checkpoints/